...
export default function FormularioObrigadaPage() {
  return (
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-[640px] text-center">
            <div className="mb-6 inline-flex">
              <Sticker text="MÉTODO TTS · BEM-VINDA · " emoji="✨" size={140} />
            </div>
            ...
            >
              <span className="block text-spark-ink">obrigada</span>
              <span className="block text-grad-brand">pela confiança.</span>
            </h1>

            <p className="mt-7 text-fluid-lead text-spark-ink-70 leading-snug font-semibold max-w-[44ch] mx-auto">
              Seu cadastro chegou aqui. Em breve uma especialista vai te chamar no
              WhatsApp pra entender melhor teu momento e te abrir as portas do método 💕
            </p>
