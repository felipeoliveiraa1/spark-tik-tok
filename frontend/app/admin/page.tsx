...
function Funnel({ stages }: { stages: FunnelStage[] }) {
  ...
  // Largura minima do trapezio. 0.35 garante que o numero (24px) +
  // label (10px, ate ~24 chars) cabem dentro em branco. O afunilamento
  // visual ainda eh expressivo entre topo e base, e os numeros exatos
